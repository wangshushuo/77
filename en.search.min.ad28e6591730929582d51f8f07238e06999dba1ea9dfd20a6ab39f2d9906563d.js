...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.669bd355da43882f762d2d34011f8331fb30f0f503808902659514cdac3155a9.js',function(){input.required=false;search();});}
