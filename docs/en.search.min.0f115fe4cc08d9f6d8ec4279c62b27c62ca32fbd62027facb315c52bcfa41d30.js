...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.466cd6ef602357d948fae4d37d18383022eb02395102f5a05282a6bd336653d1.js',function(){input.required=false;search();});}
