...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.306bf4b85ab644241ade0fe8ae0edd079a4f7392288d492d580033679636f2cd.js',function(){input.required=false;search();});}
