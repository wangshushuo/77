...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9a9a6b619389e563f698b72184f4f6bac2cd1bcf355ba31f1364af55e46ca1d5.js',function(){input.required=false;search();});}
