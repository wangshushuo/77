...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.20cbf76714bbbaf1ac5bcae3cc4d0a959c8ae63a6f6bbd4ecfb337ea34106db7.js',function(){input.required=false;search();});}
