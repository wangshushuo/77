...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.44ed63416102a184d8475fc20a2be7e150833ee25e311e86e8c11293559a4ba0.js',function(){input.required=false;search();});}
