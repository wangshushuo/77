...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0a9c19a7b1198cca62ee63721fa73f363df8aad82996bc39aa9c8b07730de9a7.js',function(){input.required=false;search();});}
